...
*/
export function draw_line(canvas_id, draw_type) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(draw_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.draw_line(retptr, ptr0, len0, ptr1, len1);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_vertexAttribPointer_c22b4601ff93f9d3 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('draw_line_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
