...
function __wbg_adapter_24(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__h0c9e14fa6fc84a0e(arg0, arg1, arg2);
}

/**
*/
export function wasm_canvas_stress() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_canvas_stress(retptr);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_canvas_stress_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
