...
*/
export function draw_triangle_scale() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.draw_triangle_scale(retptr);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_uniformMatrix4fv_a9b0a01452223f3e = function(arg0, arg1, arg2, arg3) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('draw_triangle_scale_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
