...
function __wbg_adapter_16(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__hcd72cef270abc3ed(arg0, arg1, arg2);
}

/**
*/
export function cube_rotate() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.cube_rotate(retptr);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('cube_rotate_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
